# Catherine was having trouble making an ARIMA model on simulated data.
# The issue seems to be that it was too similar.
# So first try pulling in some simulated data to see if you can do it.

# Pull in simulated data
library(tswge)
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/vpmax_1_to_50_attempt2.csv"
vpmax_sims <- read.csv(file_path, header = TRUE)
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/tdew_1_to_50_attempt2.csv"
...
# Get the first sim
vpmax_sim = vpmax_sims[,1]
tdew_sim = tdew_sims[,1]
temp_sim = temp_sims[,1]

# Constants
season = 6*24 # 6 10-minute periods per hour * 24 hours in a day
h_max = 720 # horizons are 96, 192, 336, and 720
train_len = 6*24*366 - h_max # total length is 6*24 time points in a day * 366 days

# VPMax forecast
vpmax_d = diff(vpmax_sim,season)
vpmax_est <- est.arma.wge(vpmax_d, p=9, q=5) # these are values Aaron found
...
vpmax_fore_max <- fore.arima.wge(vpmax_sim, phi= vpmax_phi, theta = vpmax_theta, s=season, 
                                 lastn=TRUE, n.ahead = h_max, plot = FALSE)$f
...
plot(1:h_max, vpmax_tail_max, type = "l", col = "black", lwd = 2,
     ...
     main = "ARIMA(9,5 with s = 144): Last 720 Observed + Forecasted - VPMax")
...
tdew_est <- est.arma.wge(tdew_d, p=7, q=5)
...
plot(1:h_max, tdew_tail_max, type = "l", col = "black", lwd = 2,
     ...
     main = "ARIMA(4,4 with s = 144): Last 720 Observed + Forecasted - TDew")
...
# Yup, I'm getting Catherine's error:
#   Error in solve.default(res$hessian * n.used, A) : 
#     system is computationally singular: reciprocal condition number = 3.05517e-18
summary(fit)
plot(fit$residuals)

################################################################################

# Now try using simulated (still linear) data with more noise
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/vpmax_1_to_50_varTemp02.csv"
vpmax_sims <- read.csv(file_path, header = TRUE)
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/tdew_1_to_50_varTemp02.csv"
tdew_sims <- read.csv(file_path, header = TRUE)
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/temp_1_to_50_varTemp02.csv"
temp_sims <- read.csv(file_path, header = TRUE)
vpmax_sim = vpmax_sims[,1]
tdew_sim = tdew_sims[,1]
temp_sim = temp_sims[,1]
...
vpmax_d = diff(vpmax_sim,season)
vpmax_est <- est.arma.wge(vpmax_d, p=9, q=5) 
vpmax_phi <- vpmax_est$phi
vpmax_theta <- vpmax_est$theta
vpmax_fore_max <- fore.arima.wge(vpmax_sim, phi= vpmax_phi, theta = vpmax_theta, s=season, 
                                 lastn=TRUE, n.ahead = h_max, plot = FALSE)$f
...
tdew_trim <- tdew_sim[1:train_len]
fit = arima(temp_trim, order = c(4, 0, 1), xreg = cbind(vpmax_trim, tdew_trim)) 
# the reciprocal condition number is slightly different, that's something
# system is computationally singular: reciprocal condition number = 1.07623e-17
summary(fit)
plot(fit$residuals)

# What about with the nonlinear ones?
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/vpmax_1_to_50_varTemp02.csv"
vpmax_sims <- read.csv(file_path, header = TRUE)
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/tdew_1_to_50_varTemp02.csv"
tdew_sims <- read.csv(file_path, header = TRUE)
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/tempNonLin_1_to_50_varTemp02.csv"
temp_sims <- read.csv(file_path, header = TRUE)
vpmax_sim = vpmax_sims[,1]
tdew_sim = tdew_sims[,1]
temp_sim = temp_sims[,1]
...
summary(fit)
plot(fit$residuals)
# Yay, it made a model finally

# 0.5 var with linear
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/vpmax_1_to_50_varTemp05.csv"
vpmax_sims <- read.csv(file_path, header = TRUE)
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/tdew_1_to_50_varTemp05.csv"
tdew_sims <- read.csv(file_path, header = TRUE)
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/temp_1_to_50_varTemp05.csv"
temp_sims <- read.csv(file_path, header = TRUE)
vpmax_sim = vpmax_sims[,1]
tdew_sim = tdew_sims[,1]
temp_sim = temp_sims[,1]
...
tdew_trim <- tdew_sim[1:train_len]
fit = arima(temp_trim, order = c(4, 0, 1), xreg = cbind(vpmax_trim, tdew_trim)) 
# weird, it's lower now, not higher
# reciprocal condition number = 1.62278e-19
summary(fit)
plot(fit$residuals)

# 0.1 var with linear, now that I fixed the variance bug
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/vpmax_1_to_50_varTemp01.csv"
vpmax_sims <- read.csv(file_path, header = TRUE)
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/tdew_1_to_50_varTemp01.csv"
tdew_sims <- read.csv(file_path, header = TRUE)
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/temp_1_to_50_varTemp01.csv"
temp_sims <- read.csv(file_path, header = TRUE)
vpmax_sim = vpmax_sims[,1]
tdew_sim = tdew_sims[,1]
temp_sim = temp_sims[,1]
...
plot(1:h_max, temp_tail_max, type = "l", col = "black", lwd = 2,
     ...
     main = "MLR + ARMA(4,1) Forecast with Forecasted Exogenous Variables")
lines(1:h_max, temp_fore_max, col = "blue", lwd = 2)
legend("topleft", legend = c("Observed", "Forecasted"), col = c("black", "blue"), lty = 1, lwd = 2)
MSE_720 <- mean((temp_tail_max-temp_fore_max)^2) 
MSE_720

################################################################################

# Loop through multiple sims
...
# Parameters
numSims = 50 # set to 50 for real sims
startSim = 1
toPlot = FALSE # set this to TRUE for testing, and FALSE when doing all 50 sims
...
write_csv(error_df, paste("C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Results/ARIMA_Errors_",fileStr,".csv",sep=""))
write_csv(fore_df, paste("C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Forecasts/ARIMA_Forecasts_",fileStr,".csv",sep=""))
