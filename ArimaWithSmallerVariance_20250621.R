...
fileStr = '1_to_50_varTemp001varFac05'
...
file_path = paste("C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/tdew_",fileStr,".csv",sep="")
tdew_sims <- read.csv(file_path, header = TRUE)
file_path = paste("C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/tempNonLin_",fileStr,".csv",sep="")
temp_sims <- read.csv(file_path, header = TRUE)
file_path = "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Sims/Signal.csv"
sig <- read.csv(file_path, header = TRUE)
sig_tail_max = tail(sig$T..degC.,h_max)
...
# Save off error metrics and forecasts
write_csv(error_df, paste("C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Results/ARIMA_NonLin_Errors_",fileStr,".csv",sep=""))
write_csv(fore_df, paste("C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Forecasts/ARIMA_NonLin_Forecasts_",fileStr,".csv",sep=""))
...
for (iSim in startSim:numSims){
  ...
  # Get training data
  # temp_trim <- temp_sim[1:train_len]
  temp_trim <- temp_sim[(6*24*366/2 + 1):train_len]
  # vpmax_trim <- vpmax_sim[1:train_len]
  vpmax_trim <- vpmax_sim[(6*24*366/2 + 1):train_len]
  # tdew_trim <- tdew_sim[1:train_len]
  tdew_trim <- tdew_sim[(6*24*366/2 + 1):train_len]
...
# Save off error metrics and forecasts
write_csv(error_df, paste("C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Results/ARIMA_HalfLen_Errors_",fileStr,".csv",sep=""))
write_csv(fore_df, paste("C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Forecasts/ARIMA_HalfLen_Forecasts_",fileStr,".csv",sep=""))
