...
# Save off VPMax intermediate as CSV
write.csv(y_gen_vpmax_mult, "y_gen_vpmax_mult_20250504.csv", row.names = FALSE) # apparently write_csv is faster

################################################################################
# OK, that crashed my R, so trying again.  
# I'd like to do it where each loop creates the vpmax adjusted, tdew adjusted, tempLin, and tempNonlin
library(tswge)
file_path = "https://raw.githubusercontent.com/aabromowitz/Capstone/refs/heads/main/weather_interpolation.csv"
weather <- read.csv(file_path, header = TRUE)
file_path = "https://raw.githubusercontent.com/aabromowitz/Capstone/refs/heads/main/vectors_VPMax.csv"
...
# Try plotting to make sure that everything looks similar to what we're used to
...
legend('top',legend = c("Real Data", "VPMax + TDew - Linear", "VPMax + TDew - Nonlinear"), 
       col = c("red", "blue", "green"),pch=1)
# Plots looked reasonable, so generating 50k now

# ChatGPT thought I should try to a .parquet file instead of a .csv file
install.packages("arrow")
library(arrow)
write_parquet(y_gen_vpmax_adj, "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Datasets/y_gen_vpmax_adj_1_to_5000_20250504.parquet")
write_parquet(y_gen_tdew_adj, "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Datasets/y_gen_tdew_adj_1_to_5000_20250504.parquet")
write_parquet(y_gen_TLin_adj, "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Datasets/y_gen_TLin_adj_1_to_5000_20250504.parquet")
write_parquet(y_gen_TNonlin_adj, "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Datasets/y_gen_TNonlin_adj_1_to_5000_20250504.parquet")

# Can I pull it back in?
testParquet <- read_parquet("C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Datasets/y_gen_vpmax_adj_1_to_5000_20250504.parquet")
plot(testParquet[[1]]) # It's a tibble, so you have to plot it kinda differently, but it is the right thing