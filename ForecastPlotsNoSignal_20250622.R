...
dest.dir <- "C:/Users/aabro/OneDrive/Desktop/SMU Program/Capstone/Plots/RunForJun7_NoSignal"
...
for (iPlot in 1:num_plots){
  ...
  legend('top',legend = c("Simulation", "ARIMA Forecast", "TFT Forecast"), 
         col = c("blue", "red", "magenta"),pch=1)
  ticks <- axTicks(1)
